import HeaderProfileButton from "@/app/(root)/_components/header/HeaderProfileButton"
        ...
        <div className="relative h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <SignedOut>
              ...
              bg-gradient-to-r from-amber-500/10 to-orange-500/10 hover:from-amber-500/20 hover:to-orange-500/20 transition-all duration-300" >
