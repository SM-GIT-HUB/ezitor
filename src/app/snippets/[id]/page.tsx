...
function SnippetPage() {
  ...
  const comments = useQuery(api.snippets.getSnippetComments, { snippetId: snippetId as Id<"snippets"> });
    ...
    <div className="min-h-screen bg-[#0a0a0f]">
      ...
      <main className="max-w-[90rem] mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12">
        <div className="max-w-[1200px] mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-2">
              <div className="flex items-center gap-4">
                <div className="flex items-center justify-center size-12 rounded-xl bg-[#ffffff08] p-2.5">
                  <img src={`/${snippet.language}.png`} alt={`${snippet.language} logo`} className="w-full h-full object-contain" />
                </div>
          ...
          <Comments snippetId={snippet._id} comments={comments || []} />
        </div>
      </main>
    </div>
  )
