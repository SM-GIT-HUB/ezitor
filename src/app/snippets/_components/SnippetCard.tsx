...
function SnippetCard({ snippet }: { snippet: Snippet }) {
  ...
  const cls1 = "bg-red-500/20 text-red-400 cursor-not-allowed";
  const cls2 = "bg-gray-500/10 text-gray-400 hover:bg-red-500/10 hover:text-red-400";
  ...
  return (
    <motion.div layout className="group relative" whileHover={{ y: -2 }} transition={{ duration: 0.2 }} >
      <Link href={`/snippets/${snippet._id}`} className="h-full block">
        <div className="relative h-full bg-[#1e1e2e]/80 backdrop-blur-sm border border-[#313244]/50
        rounded-xl hover:border-[#313244] transition-all duration-300 overflow-hidden" >
          <div className="p-6">
            ...
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center gap-3">
                <div className="relative">
                  ...
                  rounded-lg blur opacity-20 group-hover:opacity-30 transition-all duration-500" area-hidden="true" />
                  ...
                  group-hover:from-blue-500/20 group-hover:to-purple-500/20 transition-all duration-500" >
                    <Image src={`/${snippet.language}.png`} alt={`${snippet.language} logo`} width={24} height={24}
