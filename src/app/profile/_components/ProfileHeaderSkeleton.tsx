    ...
    <div className="relative mb-8 bg-gradient-to-br from-[#12121a] to-[#1a1a2e]rounded-2xl p-8 border border-gray-800/50 overflow-hidden" >
      ...
      <div className="relative flex items-center gap-8">
        ...
        <div className="relative">
          ...
          <div className="absolute -top-2 -right-2 w-8 h-8 bg-gradient-to-r
          from-purple-500/50 to-purple-600/50 rounded-full z-20 animate-pulse" />
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
        {
          [1, 2, 3].map((i) => (
            <div key={i} className="group relative p-4 rounded-xl bg-gray-800/20 border border-gray-800/50 overflow-hidden" >
