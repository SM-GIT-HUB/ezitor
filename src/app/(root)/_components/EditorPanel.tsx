...
import { EditorPanelSkeleton } from "./editor-panel/EditorPanelSkeleton"
import ShareSnippetDialog from "./editor-panel/ShareSnippetDialog"
      ...
      <div className="relative bg-[#12121a]/90 backdrop-blur rounded-xl border border-white/[0.05] p-6">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* Share Button */}
            <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} onClick={() => setIsShareDialogOpen(true)}
